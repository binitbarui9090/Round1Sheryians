...
var keyboradRemove = document.querySelector(".keyboard-remove");

keyboradRemove.addEventListener("mouseenter",function () {
...
keyboradRemove.addEventListener("mouseleave",function () {
...
whatwedone.addEventListener("mouseleave",function () {
    ...
    cursorOutline.style.height = "30px"
    cursorOutline.style.width = "30px"
    gsap.to(page2h1, { color: "black", duration: 0.5 });
    gsap.to(page2, { background: "white", duration: 0.5 });
})
...
let sliderimg = document.querySelector(".image");
